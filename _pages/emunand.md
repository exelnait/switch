...
1. Если вы хотите перенести свой профиль из SysNAND в EmuNAND, то убедитесь, что в пункте **Copy USER partition to EmuNAND** стоит **Yes**
    * В норме процесс создания эмунанда во внутренней памяти занимает не больше получаса. Если вы видите, что в вашем случае это не так, то вам придётся делать EmuANND через hekate. Как это сделать, [описано здесь](emunand-atmo){:target="_blank"}
